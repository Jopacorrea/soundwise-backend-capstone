...
app.listen(PORT, () => {
  ...
  console.log(`Backend service URL: https://soundwise-backend-capstone.onrender.com`);
  console.log(`Frontend application URL: https://soundwise-capstone.onrender.com`);
});